...
const Header = ({ lunch, day, yoil, weather, selectLocation, selectedSchool, coronaTotal, coronaCountry }) => {
  return (
    <section className={styles.header}>
      ...
      <div className={styles.right}>
        <div className={styles.select}>
          <SchoolSelect selectLocation={selectLocation} selectedSchool={selectedSchool} />
        </div>
      </div>
